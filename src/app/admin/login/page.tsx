  ...
  return (
    <div style={{
      ...
      <div style={{ textAlign: "center", marginBottom: "28px" }}>
        ...
        <div style={{ fontSize: "1.125rem", fontWeight: 800, color: "var(--primary)", letterSpacing: 0.5 }}>
          IV ATTENDANCE TRACKER
        </div>
        <div className="hint" style={{ marginTop: 4 }}>Administrator Portal</div>
      </div>
